...
#################################################
# MÓDULO DE AUTONOMOUS DATABASE - DESARROLLO 1
#################################################
module "adb_dev" {
  source = "./modules/adb"
  ...
  oci_adb_db_name        = var.oci_adb_db_name_dev_1
  oci_adb_admin_password = var.oci_adb_admin_password_dev_1
  oci_adb_db_workload    = var.oci_adb_db_workload_dev_1

  # Resource allocation
  oci_adb_compute_count           = var.oci_adb_compute_count_dev_1
  oci_adb_data_storage_size_in_gb = var.oci_adb_data_storage_size_in_gb_dev_1
  oci_adb_is_auto_scaling_enabled = var.oci_adb_is_auto_scaling_enabled_dev_1

  # Licensing and tier
  oci_adb_license_model = var.oci_adb_license_model_dev_1
  oci_adb_is_dev_tier   = var.oci_adb_is_dev_tier_dev_1

  depends_on = [module.vcn_dev]
}

#################################################
# MÓDULO DE DB SYSTEM - DESARROLLO 1
#################################################
module "dbsystem_dev" {
  source = "./modules/dbsystem"

  # Configuration parameters
  oci_dbs_db_name                  = var.oci_dbs_dbname_dev_1
  ...
  oci_dbs_database_admin_password  = var.oci_dbs_admin_password_dev_1
